...
class StrategyManagerTest extends TestCase
{
    ...
    {
        $strategy = new StringRandomStrategy(strategyName: 'exactly8', options: ['prefix' => 'usr_', 'length' => 8]);
    ...
    {
        $email1 = $this->strategyManager->generate('email_fake', 'test', salt: '55');
        $email2 = $this->strategyManager->generate('email_fake', 'test', salt: '55');
