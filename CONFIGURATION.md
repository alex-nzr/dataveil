...
fields:
    - column: "NAME"
      strategy: "string_initial"
```

Эти стратегии полезны, когда нужно обезличить ФИО, но сохранить визуально узнаваемый формат интерфейса: короткая фамилия и инициалы вместо полностью сгенерированных значений.
